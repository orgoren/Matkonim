...
# define sql queries
add_food = """INSERT INTO FOOD_RECIPES (food_id, prep_time_in_minutes, food_details) VALUES ({},{},'{}');"""
...
with open(INPUT_FILE, 'r') as fin:
    ...
    for row in reader:
        ...
        if (food_id, prep_time_minutes, food_details) in food_set:
            ...
            food_set.add((food_id, recipe_id, prep_time_minutes, food_details))
...
food_recipe_sql = open('insert_food_recipe.sql', 'w')
food_recipe_sql.write(add_food_recipe_queries)

recipes_sql2 = open('insert_all_recipes2.sql', 'w')
